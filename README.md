...
- Images created by Tableau, although they are static here, for full functionalities of responsive dashboards, please open bank_analysis.twbx in Tableau
- SQL Query used in this analysis: QUERY DOCUMENT.docx, bank_loan_sql.sql
- Data Set: financial_loan.csv
...
##  3. Probelem Statement <a name="section2"></a>
### Dashboard 1: Summary
